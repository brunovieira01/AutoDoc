...
if uploaded_file is not None:
    # Step 0: Check file requirements
    # File Type
    ...
    max_size_mb = 25 * 1024 * 1024  # 25 MB in bytes
    if file_size > max_size_mb:
        st.error(f"Error: File size exceeds the 25MB limit. Your file size is {file_size / (1024 * 1024):.2f}MB.")
